        ...
        <div class="sub_inner">
            <div class="breadcrumb_wrap">
                <nav class="breadcrumb">
                    ...
                    <i class="dot"></i>
                    <span class="depth2 current"><?php echo $lang['sub_proc_braised']; ?></span>
                </nav>
                
                <div class="sub_title_group">
                    <h2 class="sub_page_title"><?php echo $lang['sub_proc_braised']; ?></h2>
    ...
    <section class="process_content_section">
        <div class="process_inner">
            <div class="process_top_info">
                <div class="tit_group">
                    <span class="sub_tit"><?php echo $lang['proc_braised_top_sub']; ?></span>
                    <h3 class="main_tit"><?php echo $lang['proc_braised_top_main']; ?></h3>
                </div>
                <p class="desc_txt">
                    <?php echo nl2br($lang['proc_braised_top_desc']); ?>
                </p>
            </div>
            ...
            <div class="step_grid_container">
                ...
                foreach($step_numbers as $num):
                    $tit_key = 'proc_braised_step' . $num . '_tit';
                    $desc_key = 'proc_braised_step' . $num . '_desc';
                ?>
                <div class="step_item">
                    <div class="step_head">
                    ...
                    <div class="step_img" style="background-image: url('/images/sub/02-<?php echo $num; ?>.png');"></div>
                </div>
                <?php endforeach; ?>
            </div>
        </div>
