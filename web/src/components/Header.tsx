    ...
    <header id="header">
      <div className="header_inner">
        ...
        <div className="gnb_wrap">
          <nav className="gnb" aria-label="PC navigation">
            <div className="gnb_grid">
              <a href="#" className="gnb_main_link"><span>{t('menu_about')}</span></a>
              <a href="#" className="gnb_main_link"><span>{t('menu_business')}</span></a>
              <a href="#" className="gnb_main_link"><span>{t('menu_product')}</span></a>
              <a href="#" className="gnb_main_link"><span>{t('menu_news')}</span></a>
              <a href="#" className="gnb_main_link"><span>{t('menu_support')}</span></a>
            </div>
          </nav>
        ...
        <div className="util_area">
          <Link href="/contact" className="btn_inquiry">
            <span>{t('menu_inquiry')}</span>
          </Link>
          <LanguageSwitcher />
          <button type="button" className="mo_menu_btn">
